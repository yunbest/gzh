<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"app/view/admin/admin\admin_article\add.html";i:1535943828;s:48:"F:\myapp\wxgzh\app\view\admin\public\header.html";i:1535607506;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" style="width:400px;" required value=""
                                   ...
                                   readonly/>
                            <input class="form-control" type="hidden" value="" name="article[categories]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="article[article_title]"
                    ...
                    <tr>
                        <th>关键词</th>
                        <td>
                            <input class="form-control" type="text" name="article[article_keywords]" id="keywords" value=""
                                   placeholder="请输入关键字">
                    ...
                    <tr>
                        <th>文章来源</th>
                        <td><input class="form-control" type="text" name="article[article_source]" id="source" value=""
                                   placeholder="请输入文章来源"></td>
                    </tr>
                    <tr>
                        <th>摘要</th>
                        <td>
                            <textarea class="form-control" name="article[article_excerpt]" style="height: 50px;"
                    ...
                    <tr>
                        <th>内容</th>
                        <td>
                            <script type="text/plain" id="content" name="article[article_content]"></script>
                        </td>
            ...
            <div class="col-md-3">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="article[more][thumbnail]" id="thumbnail" value="">
                    ...
                    <tr>
                        <td>
                            <input class="form-control js-bootstrap-datetime" type="text" name="article[published_time]"
