<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"app/view/admin/admin\main\index.html";i:1535607503;s:48:"F:\myapp\wxgzh\app\view\admin\public\header.html";i:1535607506;}*/ ?>
...
<?php 
    \think\Hook::listen('admin_before_head_end',$temp5b8d262304bcb,null,false);
 ?>
</head>
<body>
<div class="wrap">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body home-info">
                    <ul id="thinkcmf-notices" class="list-unstyled">
                        <li>
                            <img src="/app/view/admin/public/assets/images/loading.gif" style="vertical-align: middle;"/>
...
<?php 
    \think\Hook::listen('admin_before_body_end',$temp5b8d262304bcb,null,false);
 ?>
</body>
</html>