<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"app/view/admin/admin\admin_category\edit.html";i:1535711529;s:48:"F:\myapp\wxgzh\app\view\admin\public\header.html";i:1535607506;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('AdminCategory/add'); ?>">编辑分类</a></li>
    </ul>
    <div class="row margin-top-20">

        <div class="col-md-3">
            <form class="js-ajax-form" action="<?php echo url('AdminCategory/edit'); ?>" method="post">
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="input-name" name="name" value="<?php echo $vo['name']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="input-alias" name="alias" value="<?php echo $vo['description']; ?>">
                            </div>
                        </div>
