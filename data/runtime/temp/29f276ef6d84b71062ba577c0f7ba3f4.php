...
<head>
    ...
    <link rel="stylesheet" href="/app/view/admin/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <!--[if lt IE 9]>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/app/view/admin/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
...
<script src="/app/view/admin/public/assets/simpleboot3/js/adminindex.js"></script>
<script>
    $(function () {
