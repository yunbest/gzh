<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"app/view/admin/admin\admin_category\add.html";i:1535714499;s:48:"F:\myapp\wxgzh\app\view\admin\public\header.html";i:1535607506;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select class="form-control" name="parent_id" id="input-parent">
                                    ...
                                    <?php else: ?>
                                        <option value="<?php echo $vo['id']; ?>">第一级菜单</option>
                                    <?php endif; ?>
                                </select>
                            </div>
                        </div>
